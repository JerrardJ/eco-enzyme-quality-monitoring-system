...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="asset/css/styles2.css?v=2.0" type ="text/css">

    <!-- Admin CSS -->
    <link rel="stylesheet" href="asset/css/admin.css?v=2.6" type="text/css">

    <title>Admin Panel - Add Account</title>
</head>
        ...
        <div class="admin-content">
            ...
            <div class="content">
                ...
                <form action="createUser.php" method="post">
                    ...
                    <div>
                        <button type="submit" name="create-admin" class="btn btn-big">Submit</button>
                    </div>
                </form>
                <!-- FORM ADD USER END -->
            </div>
